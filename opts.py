...
def model_opts(parser):
    ...
    parser.add_argument('-inter_word_vec_size', type=int, default=500,
                        help='Int word embedding sizes')
    ...
    parser.add_argument('-encoder_type', type=str, default='rnn',
                        choices=['rnn', 'brnn', 'mean', 'transformer', 'cnn','double_encoder'],
...
def train_opts(parser):
    ...
    parser.add_argument('-pre_word_vecs_enc_inter',
                        help="""If a valid path is specified, then this will load
    ...
    parser.add_argument('-fix_word_vecs_enc_inter',
                        action='store_true',
                        help="Fix word embeddings on the encoder_inter side.")
    ...
    parser.add_argument('-truncated_decoder', type=int, default=0,
                        help="""Truncated bptt.""")
    # learning rate
    parser.add_argument('-update_learning_rate', type=int, default=1,
                        help="""Update learning rate (1) or keep it fixed (0)""")
...
def preprocess_opts(parser):
    ...
    # Truncation options
    parser.add_argument('-src_seq_length', type=int, default=80,
                        help="Maximum source sequence length")
    parser.add_argument('-src_seq_length_trunc', type=int, default=0,
                        help="Truncate source sequence length.")
    parser.add_argument('-inter_seq_length', type=int, default=80,
                        help="Maximum inter sequence length")
    parser.add_argument('-inter_seq_length_trunc', type=int, default=0,
                        help="Truncate inter sequence length.")
    parser.add_argument('-tgt_seq_length', type=int, default=80,
    ...
    parser.add_argument('-share_vocab_inter_tgt', action='store_true',
                        help="Share inter and target vocabulary")
