...
PackedSequence_not_sorted_ = namedtuple('PackedSequence_not_sorted', ['data', 'batch_sizes'])


class PackedSequence(PackedSequence_not_sorted_):
...
def pack_padded_not_sorted_sequence(input, lengths, batch_first=False):
...
def pad_packed_not_sorted_sequence(sequence, batch_first=False):
