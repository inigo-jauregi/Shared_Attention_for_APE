...
parser.add_argument('-train_inter',
                    help="Path to the training inter data")
parser.add_argument('-train_tgt', required=True,
                    help="Path to the training target data")
parser.add_argument('-valid_src', required=True,
                    help="Path to the validation source data")
parser.add_argument('-valid_inter',
                    help="Path to the validation inter data")
...
parser.add_argument('-inter_vocab',
                    help="Path to an existing int vocabulary")
...
def main():
    ...
    if opt.src_vocab and opt.inter_vocab and opt.tgt_vocab:
        print ("The vocabs are fixed")
    else:
        print("The vocabs are learned")
        ...
        train = onmt.IO.ONMTDataset(opt.train_src, opt.train_tgt, fields, opt, opt.train_inter)
        print("Building Vocab...")
        onmt.IO.ONMTDataset.build_vocab(train, opt)

        print("Building Valid...")
        valid = onmt.IO.ONMTDataset(opt.valid_src, opt.valid_tgt, fields, opt, opt.valid_inter)
